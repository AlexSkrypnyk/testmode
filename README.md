...
[![codecov](https://codecov.io/gh/AlexSkrypnyk/testmode/graph/badge.svg)](https://codecov.io/gh/AlexSkrypnyk/testmode)
...
1. When writing Behat tests, all test content items (nodes, terms, users) follow specific pattern. For example, node titles start with `[TEST]` followed by a space.
